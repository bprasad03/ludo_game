...
class Ludo:
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Roll", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Roll",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("sky_blue"))
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Roll", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("green"))
...
if __name__ == '__main__':
    ...
    window.title("Play Ludo with Bablu Prasad")
